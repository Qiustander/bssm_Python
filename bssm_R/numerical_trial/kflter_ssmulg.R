...
esty <- result$att[,1] + result$att[,2] * x1 + b2 * result$att[,3] 
# ts.plot(cbind(b1, b2, result$att[,2], result$att[,3]), col = 1:5)
# legend("bottomright", legend = c("b1", "b2", "est_level", "est_b1", "est_b2"), col = 1:4, lty = 1)
