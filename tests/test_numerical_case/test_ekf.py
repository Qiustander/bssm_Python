...
class TestExtendedKalmanFilter:
    ...
    def test_kffilter_TFP_mvmodel(self):
        ...
        """
        bssm uses the fixed intialization, and TFP uses random initialization.
        """
        # compare filtered_means
        ...
        # compare predicted_means
        # TODO: in r it computes the next step prediction! but in ekf does not
        tf.debugging.assert_near(r_result[0][:-1, ...][50:,:], infer_result[2][50:,:].numpy(), atol=1e-4)
        # compare predicted_covs
        tf.debugging.assert_near(r_result[2][..., :-1][50:,:], infer_result[3].numpy().transpose(1, 2, 0)[50:,:], atol=1e-1)
